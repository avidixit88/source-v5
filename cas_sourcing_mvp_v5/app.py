...
st.set_page_config(
    page_title="CAS Sourcing MVP v5",
    page_icon="🧪",
    layout="wide",
)

st.title("🧪 CAS Sourcing & Procurement Intelligence MVP v5")
st.caption(
    "CAS input → supplier discovery → visible pricing extraction → normalized price → bulk estimate → shortlist. "
    "v5 preserves prior modes and adds stricter product-page targeting, CAS-neighborhood extraction, and reduced search-page noise."
)
